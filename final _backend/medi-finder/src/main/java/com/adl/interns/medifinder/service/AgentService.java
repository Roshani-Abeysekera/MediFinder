...
public class AgentService {
    ...
    @Autowired
    public AgentService(CustomerEmailTokenRepository customerEmailTokenRepository
    ...
    public String agentRegisration(User user)  {
        ...
        if (user1 != null)
            ...
            mailMessage.setText("To confirm your account, please click here : "
                    + "http://localhost:8080/agent/confirm?token=" + userMailToken.getToken());
    ...
    public String verifyAgent(String confirmationToken){
